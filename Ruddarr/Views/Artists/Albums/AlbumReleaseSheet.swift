...
struct AlbumReleaseSheet: View {
    ...
    var body: some View {
        ...
        NavigationStack {
            ...
            .alert(
                isPresented: instance.albums.errorBinding,
                error: instance.albums.error
            ) { _ in
                Button("OK") { instance.albums.error = nil }
            } message: { error in
        ...
        HStack(spacing: 24) {
            ...
            Button {
                ...
                ButtonLabel(
                    ...
                    isLoading: instance.albums.isWorking
                )
                .modifier(MediaPreviewActionModifier())
            }
            .buttonStyle(.bordered)
    ...
    func downloadRelease(force: Bool = false) async {
        guard await instance.albums.download(
            guid: release.guid,
            indexerId: release.indexerId,
            albumId: force ? album.id : nil
        ) else {
            return
        }
