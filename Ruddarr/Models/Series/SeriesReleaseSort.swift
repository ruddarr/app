...
struct SeriesReleaseSort: Equatable {
    ...
    static func == (lhs: SeriesReleaseSort, rhs: SeriesReleaseSort) -> Bool {
...
extension SeriesReleaseSort: RawRepresentable {
    public init?(rawValue: String) {
        do {
            ...
            leaveBreadcrumb(.fatal, category: "series.releases.sort", message: "init failed: \(error)", data: ["error": error])
